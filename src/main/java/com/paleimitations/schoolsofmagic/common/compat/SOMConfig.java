...
public class SOMConfig {
   ...
   public static boolean wandRingDurability() {
      ...
      return enable_wand_ring_durability.get();
   }
   ...
   public static int smoke_scry_minLevel = 1;
   public static float scorch_cost = 25.0F;
   public static int scorch_minLevel = 5;
   ...
   public static float blaze_cost = 10.0F;
   ...
   public static float sun_screen_cost = 10.0F;
   public static float illuminate_cost = 10.0F;
   public static float solar_orb_cost = 20.0F;
   public static float luster_tool_cost = 30.0F;
   public static float flash_decoy_cost = 25.0F;
   public static float shining_shield_cost = 60.0F;
   ...
   public static float grow_apple_cost = 5.0F;
   ...
   public static float ice_shell_cost = 30.0F;
   ...
   public static float locate_lava_cost = 0.5F;
   public static float locate_water_cost = 0.5F;
   public static float locate_ore_coal_cost = 0.2F;
   public static float locate_ore_copper_cost = 0.2F;
   public static float locate_ore_cost = 10.0F;
   ...
   public static float practice_cost = 10.0F;
   public static float defuse_cost = 15.0F;
   ...
   public static int barren_tree_minLevel = 5;
   public static int beacon_bolt_minLevel = 5;
   public static int become_undead_minLevel = 5;
   public static int blaze_minLevel = 1;
   public static int breath_minLevel = 1;
   public static int bug_repellent_minLevel = 5;
   public static int command_undead_minLevel = 20;
   public static int cure_poison_minLevel = 1;
   public static int dimensional_banish_minLevel = 10;
   public static int dislocation_minLevel = 10;
   public static int dry_minLevel = 1;
   ...
   public static int sun_screen_minLevel = 1;
   public static int illuminate_minLevel = 1;
   public static int solar_orb_minLevel = 5;
   public static int luster_tool_minLevel = 20;
   public static int flash_decoy_minLevel = 20;
   public static int shining_shield_minLevel = 20;
   public static int empower_undead_minLevel = 5;
   public static int energize_minLevel = 5;
   public static int fiery_blessing_minLevel = 5;
   public static int fire_ring_minLevel = 5;
   public static int flamability_minLevel = 5;
   public static int gale_minLevel = 1;
   public static int gills_minLevel = 1;
   public static int glowing_minLevel = 1;
   public static int grow_apple_minLevel = 1;
   public static int grow_cactus_minLevel = 5;
   public static int grow_nightshade_minLevel = 1;
   public static int growth_minLevel = 1;
   public static int ice_shell_minLevel = 10;
   public static int ignite_minLevel = 1;
   public static int incinerate_minLevel = 5;
   ...
   public static int light_hoe_minLevel = 5;
   public static int light_pickaxe_minLevel = 5;
   public static int light_shovel_minLevel = 5;
   public static int light_sword_minLevel = 5;
   public static int locate_lava_minLevel = 1;
   public static int locate_water_minLevel = 1;
   public static int locate_ore_coal_minLevel = 1;
   public static int locate_ore_copper_minLevel = 1;
   public static int locate_ore_gem_minLevel = 10;
   public static int locate_ore_gold_minLevel = 1;
   public static int locate_ore_iron_minLevel = 1;
   public static int locate_ore_lapis_minLevel = 1;
   public static int locate_ore_lead_minLevel = 1;
   public static int locate_ore_minLevel = 5;
   ...
   public static int mutate_zombie_minLevel = 15;
   public static int part_lava_minLevel = 5;
   public static int part_water_minLevel = 5;
   public static int phantom_fire_minLevel = 1;
   public static int pollen_cloud_minLevel = 1;
   public static int practice_minLevel = 1;
   public static int defuse_minLevel = 1;
   public static int prickly_hide_minLevel = 5;
   public static int protect_undead_minLevel = 15;
   public static int quick_sand_minLevel = 1;
   public static int rabbit_jump_minLevel = 5;
   public static int raise_skeleton_minLevel = 10;
   public static int raise_zombie_minLevel = 10;
   public static int shadow_spy_minLevel = 15;
   public static int shriek_minLevel = 5;
   public static int shulker_bullet_minLevel = 5;
   public static int spectral_hand_minLevel = 10;
   public static int squid_eyes_minLevel = 5;
   public static int suffocate_minLevel = 1;
   public static int summon_rain_minLevel = 5;
   public static int summon_thunderstorm_minLevel = 5;
   public static int switch_location_minLevel = 15;
   public static int thorn_ring_minLevel = 10;
   public static int time_warp_minLevel = 1;
   public static int tremor_minLevel = 10;
   public static int true_bolt_minLevel = 10;
   public static int water_jet_minLevel = 1;
   public static int whispers_minLevel = 5;
   public static int winter_roar_minLevel = 1;
   public static int wither_blight_minLevel = 10;
   public static int wolf_strength_minLevel = 5;
   public static int zephyr_minLevel = 5;
   public static int fortified_breath_minLevel = 5;
   public static int fireball_minLevel = 35;
   public static int break_minLevel = 1;
   public static int sea_trade_minLevel = 5;
