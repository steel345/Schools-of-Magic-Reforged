...
public class SOMConfig {
   ...
   public static int sun_blast_minLevel = 19;
   public static int solar_barrage_minLevel = 24;
   public static int sundial_minLevel = 0;
   public static int sun_screen_minLevel = 0;
   public static int illuminate_minLevel = 0;
   public static int solar_orb_minLevel = 4;
   public static int luster_tool_minLevel = 19;
   public static int flash_decoy_minLevel = 19;
   public static int shining_shield_minLevel = 19;
