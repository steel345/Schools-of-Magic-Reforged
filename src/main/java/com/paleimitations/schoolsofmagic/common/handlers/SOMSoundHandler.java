...
public class SOMSoundHandler {
   ...
   public static final RegistryObject<SoundEvent> RECALL = register("spells.recall");
   public static final RegistryObject<SoundEvent> CHIMES = register("spells.chimes");
   public static final RegistryObject<SoundEvent> TP_OUT = register("spells.tp_out");
   public static final RegistryObject<SoundEvent> TP_IN = register("spells.tp_in");
   public static final RegistryObject<SoundEvent> DAZZLING_LIGHT = register("spells.dazzling_light");
   public static final RegistryObject<SoundEvent> VANISH = register("spells.vanish");
   public static final RegistryObject<SoundEvent> FOCUS = register("spells.focus");
   public static final RegistryObject<SoundEvent> SHROOM_USE1 = register("spells.shroom_use1");
   public static final RegistryObject<SoundEvent> SHROOM_USE2 = register("spells.shroom_use2");
   public static final RegistryObject<SoundEvent> SHROOM_USE3 = register("spells.shroom_use3");
   public static final RegistryObject<SoundEvent> SHROOM_EXPLODE1 = register("spells.shroom_explode1");
   public static final RegistryObject<SoundEvent> SHROOM_EXPLODE2 = register("spells.shroom_explode2");
   public static final RegistryObject<SoundEvent> SHROOM_EXPLODE3 = register("spells.shroom_explode3");
   public static final RegistryObject<SoundEvent> SHROOM_EXPLODE4 = register("spells.shroom_explode4");
   public static final RegistryObject<SoundEvent> SHROOM_EXPLODE5 = register("spells.shroom_explode5");
   ...
   public static final RegistryObject<SoundEvent> CAST_SPELL_WAVE = register("spells.cast_spell_wave");
   ...
   public static final RegistryObject<SoundEvent> SPELL_BOLT = register("spells.spell_bolt");
