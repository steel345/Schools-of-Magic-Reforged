...
public class EntityAISpellWeaknessShot extends EntityAIUseSpell {
   public EntityAISpellWeaknessShot(EntityMagician magician) {
      super(magician);
   }

   @Override
   public boolean canUse() {
      return super.canUse() && !this.magician.getTarget().hasEffect(MobEffects.WEAKNESS) && this.magician.getRandom().nextInt(20) == 0;
   }
   ...
   protected void castSpell() {
      ...
      entityspell.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 200));
