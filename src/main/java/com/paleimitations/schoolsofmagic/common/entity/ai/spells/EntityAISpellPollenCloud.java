...
public class EntityAISpellPollenCloud extends EntityAIUseSpell {
   public EntityAISpellPollenCloud(EntityMagician magician) {
      super(magician);
   }
   ...
   public boolean canUse() {
      ...
      return !this.magician.getTarget().hasEffect(PotionRegistry.sneezing.get()) && this.magician.getRandom().nextInt(20) == 0;
   }
   ...
   protected void castSpell() {
      ...
      cloud.addEffect(new MobEffectInstance(PotionRegistry.sneezing.get(), 100 + this.magician.getLevel() * 20));
