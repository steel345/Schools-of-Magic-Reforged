...
public class EntityAISpellSporeShot extends EntityAIUseSpell {
   public EntityAISpellSporeShot(EntityMagician magician) {
      super(magician);
   }
   ...
   protected void castSpell() {
      ...
      entityspell.addEffect(new MobEffectInstance(PotionRegistry.hallucination.get(), 200));
