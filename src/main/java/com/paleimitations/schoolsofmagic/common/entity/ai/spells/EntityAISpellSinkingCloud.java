...
public class EntityAISpellSinkingCloud extends EntityAIUseSpell {
   public EntityAISpellSinkingCloud(EntityMagician magician) {
      super(magician);
   }
   ...
   public boolean canUse() {
      ...
      return !this.magician.getTarget().hasEffect(PotionRegistry.cursed_sinking.get()) && this.magician.getRandom().nextInt(20) == 0;
   }
   ...
   protected void castSpell() {
      ...
      cloud.setColor(PotionRegistry.cursed_sinking.get().getColor());
      cloud.addEffect(new MobEffectInstance(PotionRegistry.cursed_sinking.get(), 100 + this.magician.getLevel() * 20));
