...
public class EntityAISpellParalysisCloud extends EntityAIUseSpell {
   public EntityAISpellParalysisCloud(EntityMagician magician) {
      super(magician);
   }
   ...
   public boolean canUse() {
      ...
      return !this.magician.getTarget().hasEffect(PotionRegistry.paralysis.get()) && this.magician.getRandom().nextInt(20) == 0;
   }
   ...
   protected void castSpell() {
      ...
      cloud.setDuration(100 + this.magician.getLevel() * 20);
      cloud.setRadiusOnUse(-0.5F);
      cloud.setWaitTime(10);
      cloud.setRadiusPerTick(-cloud.getRadius() / (float)cloud.getDuration());
      cloud.setColor(PotionRegistry.paralysis.get().getColor());
      cloud.addEffect(new MobEffectInstance(PotionRegistry.paralysis.get(), 60 + this.magician.getLevel() * 20));
