...
public class EntityAISpellSummonWolves extends EntityAIUseSpell {
   public EntityAISpellSummonWolves(EntityMagician magician) {
      super(magician);
   }
   ...
   protected int getCastingInterval() {
      return this.magician instanceof EntityDemon ? 200 : 200 + (100 - 20 * this.magician.getLevel());
   }
   ...
   protected void castSpell() {
      for (int i = 0; i < 3; i++) {
         ...
         Wolf entity = EntityType.WOLF.create(this.magician.level());
