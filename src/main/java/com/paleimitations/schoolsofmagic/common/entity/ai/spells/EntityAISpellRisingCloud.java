...
public class EntityAISpellRisingCloud extends EntityAIUseSpell {
   public EntityAISpellRisingCloud(EntityMagician magician) {
      super(magician);
   }
   ...
   public boolean canUse() {
      ...
      return !this.magician.getTarget().hasEffect(PotionRegistry.cursed_rising.get());
   }
   ...
   protected void castSpell() {
      ...
      cloud.setColor(PotionRegistry.cursed_rising.get().getColor());
      cloud.addEffect(new MobEffectInstance(PotionRegistry.cursed_rising.get(), 100 + this.magician.getLevel() * 20));
