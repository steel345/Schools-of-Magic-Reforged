...
public class EntityAISpellBlinding extends EntityAIUseSpell {
   public EntityAISpellBlinding(EntityMagician magician) {
      super(magician);
   }

   @Override
   public boolean canUse() {
      return super.canUse() && this.magician.getLevel() > 0 && !this.magician.getTarget().hasEffect(MobEffects.BLINDNESS) && this.magician.getRandom().nextInt(20) == 0;
   }
   ...
   protected void castSpell() {
      ...
      entityspell.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 200));
