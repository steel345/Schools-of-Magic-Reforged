...
public class SpellLocateWater extends Spell {
   public int radius;

   public SpellLocateWater() {
      super(
         new ResourceLocation("som", "locate_water"),
         SOMConfig.locate_water_cost,
         false,
         SOMConfig.locate_water_minLevel,
         0,
   ...
   public SpellLocateWater(CompoundTag nbt) {
   ...
   private boolean isWater(Level world, BlockPos pos) {
