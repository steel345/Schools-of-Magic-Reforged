...
public class PageElementManaMinLevel extends PageElement {
   ...
   public PageElementManaMinLevel(Spell spell, int x, int y, int width, int height, int fontColor, boolean centered) {
      super(x, y);
      this.spell = spell;
      this.width = width;
      this.height = height;
