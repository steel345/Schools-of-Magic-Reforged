...
public class ItemPotionLingering extends PotionBase {
   public ItemPotionLingering(Item.Properties props) {
      super(props);
   }
   ...
   public Component getName(ItemStack stack) {
      IPotionData data = CapabilityPotionData.getCapability(stack);
      if (data != null) {
         String name = Component.translatable("potion.lingering.name").getString();
         if (data.getPotionEffects().isEmpty()) {
            name = Component.translatable("potion.lingering_empty.name").getString();
         } else {
