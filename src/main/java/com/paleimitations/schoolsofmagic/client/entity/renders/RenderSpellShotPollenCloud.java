...
public class RenderSpellShotPollenCloud extends EntityRenderer<EntitySpellShotPollenCloud> {
   private static final ResourceLocation TEXTURE = new ResourceLocation("som", "textures/entity/spell_pollen_cloud.png");
   private final ShulkerBulletModel<EntitySpellShotPollenCloud> model;

   public RenderSpellShotPollenCloud(EntityRendererProvider.Context context) {
      super(context);
   ...
   @Override
   public ResourceLocation getTextureLocation(EntitySpellShotPollenCloud entity) { return TEXTURE; }

   @Override
   public void render(EntitySpellShotPollenCloud entity, float entityYaw, float partialTicks,
