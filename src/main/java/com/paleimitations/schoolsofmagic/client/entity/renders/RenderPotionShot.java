...
public class RenderPotionShot extends EntityRenderer<EntityPotionShot> {
   private static final ResourceLocation SHULKER_SPARK_TEXTURE = new ResourceLocation("som", "textures/entity/potion_shot.png");
   private final ShulkerBulletModel<EntityPotionShot> model;

   public RenderPotionShot(EntityRendererProvider.Context context) {
      super(context);
   ...
   @Override
   public ResourceLocation getTextureLocation(EntityPotionShot entity) {
      return SHULKER_SPARK_TEXTURE;
   }

   @Override
   public void render(EntityPotionShot entity, float entityYaw, float partialTicks,
