...
public class RenderMagicCircleShriek extends EntityRenderer<EntityMagicCircleShriek> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("som", "textures/entity/magiccircle.png");
   private final ModelMagicCircle<EntityMagicCircleShriek> model;

   public RenderMagicCircleShriek(EntityRendererProvider.Context context) {
      super(context);
   ...
   @Override
   public ResourceLocation getTextureLocation(EntityMagicCircleShriek entity) {
      return TEXTURES;
   }

   @Override
   public void render(EntityMagicCircleShriek entity, float entityYaw, float partialTicks,
