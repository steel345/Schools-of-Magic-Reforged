...
public class RenderSpellShotNightshade extends EntityRenderer<EntitySpellShotNightshade> {
   private static final ResourceLocation TEXTURE = new ResourceLocation("som", "textures/entity/spell_nightshade.png");
   private final ShulkerBulletModel<EntitySpellShotNightshade> model;

   public RenderSpellShotNightshade(EntityRendererProvider.Context context) {
      super(context);
   ...
   @Override
   public ResourceLocation getTextureLocation(EntitySpellShotNightshade entity) { return TEXTURE; }

   @Override
   public void render(EntitySpellShotNightshade entity, float entityYaw, float partialTicks,
