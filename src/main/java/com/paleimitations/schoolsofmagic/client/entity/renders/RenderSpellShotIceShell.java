...
public class RenderSpellShotIceShell extends EntityRenderer<EntitySpellShotIceShell> {
   private static final ResourceLocation TEXTURE = new ResourceLocation("som", "textures/entity/spell_ice_shell.png");
   private final ShulkerBulletModel<EntitySpellShotIceShell> model;

   public RenderSpellShotIceShell(EntityRendererProvider.Context context) {
      super(context);
   ...
   @Override
   public ResourceLocation getTextureLocation(EntitySpellShotIceShell entity) { return TEXTURE; }

   @Override
   public void render(EntitySpellShotIceShell entity, float entityYaw, float partialTicks,
