...
public class RenderMagicCircleWhispers extends EntityRenderer<EntityMagicCircleWhispers> {
   public static final ResourceLocation TEXTURES = new ResourceLocation("som", "textures/entity/magiccircle.png");
   private final ModelMagicCircle<EntityMagicCircleWhispers> model;

   public RenderMagicCircleWhispers(EntityRendererProvider.Context context) {
      super(context);
   ...
   @Override
   public ResourceLocation getTextureLocation(EntityMagicCircleWhispers entity) {
      return TEXTURES;
   }

   @Override
   public void render(EntityMagicCircleWhispers entity, float entityYaw, float partialTicks,
      ...
      var vc = buf.getBuffer(RenderType.entityCutout(this.getTextureLocation(entity)));
