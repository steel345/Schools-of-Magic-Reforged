...
public class RenderSpellShotCactus extends EntityRenderer<EntitySpellShotCactus> {
   private static final ResourceLocation TEXTURE = new ResourceLocation("som", "textures/entity/spell_cactus.png");
   private final ShulkerBulletModel<EntitySpellShotCactus> model;

   public RenderSpellShotCactus(EntityRendererProvider.Context context) {
      super(context);
   ...
   @Override
   public ResourceLocation getTextureLocation(EntitySpellShotCactus entity) {
      return TEXTURE;
   }

   @Override
   public void render(EntitySpellShotCactus entity, float entityYaw, float partialTicks,
