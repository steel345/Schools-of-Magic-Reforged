...
public class TalismanSlotInventoryHandler {
   ...
   public static void onRender(ScreenEvent.Render.Post event) {
      ...
      if (Minecraft.getInstance().player != null
            && !com.paleimitations.schoolsofmagic.common.entity.capabilities.garment_data.GarmentSlots.shows(Minecraft.getInstance().player, com.paleimitations.schoolsofmagic.common.entity.capabilities.garment_data.IGarmentData.SHOW_TALISMAN)) {
   ...
   public static void onClick(ScreenEvent.MouseButtonPressed.Pre event) {
      ...
      if (over(mx, my, x, y)) {
         if (net.minecraft.client.gui.screens.Screen.hasShiftDown()) {
               ...
               new com.paleimitations.schoolsofmagic.common.network.PacketToggleSlotShow(com.paleimitations.schoolsofmagic.common.entity.capabilities.garment_data.IGarmentData.SHOW_TALISMAN));
