   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition bbmain = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 14)
            .addBox(-2.0F, -3.0F, -2.0F, 4.0F, 3.0F, 4.0F)
            .texOffs(0, 0)
            .addBox(-3.0F, -4.0F, -3.0F, 6.0F, 1.0F, 6.0F)
            .texOffs(0, 7)
            .addBox(-2.5F, -6.0F, -2.5F, 5.0F, 2.0F, 5.0F)
            .texOffs(12, 14)
            .addBox(-3.0F, -3.0F, 1.0F, 2.0F, 1.0F, 2.0F)
            .texOffs(15, 7)
            .addBox(-1.0F, -5.0F, -3.0F, 2.0F, 3.0F, 2.0F)
            .texOffs(0, 0)
            .addBox(2.0F, -3.0F, 0.0F, 1.0F, 1.0F, 2.0F),
