...
public class PieModel extends EntityModel<Entity> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition bbmain = partdefinition.addOrReplaceChild(
         "bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 2.0F, 8.0F), PartPose.offset(0.0F, 24.0F, 0.0F)
      );
