...
public class BreadModel extends EntityModel<Entity> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition bbmain = partdefinition.addOrReplaceChild(
         "bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -4.0F, -3.0F, 9.0F, 4.0F, 6.0F), PartPose.offset(0.0F, 24.0F, 0.0F)
      );
