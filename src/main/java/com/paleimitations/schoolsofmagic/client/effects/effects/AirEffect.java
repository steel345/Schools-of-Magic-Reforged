...
public class AirEffect extends ImitationSpiteEffect {
   private boolean flip;
   private float startRot;

   public AirEffect(Level world, double x, double y, double z, boolean flipped, float startRot) {
      super(ImitationSpriteLibrary.air, world, x, y, z, 0.0, 0.0, 0.0, 1.0f, 0, 0, Color.WHITE);
      this.flip = flipped;
      this.startRot = startRot;
   }

   public AirEffect(Level world, double x, double y, double z, float scale, int age, int maxAge, boolean flipped, float startRot) {
      super(ImitationSpriteLibrary.air, world, x, y, z, 0.0, 0.0, 0.0, scale, age, maxAge, Color.WHITE);
      this.flip = flipped;
      this.startRot = startRot;
   }

   public AirEffect(Level world, double x, double y, double z, double vX, double vY, double vZ, float scale, int age, int maxAge, Color color, boolean flipped, float startRot) {
      super(ImitationSpriteLibrary.air, world, x, y, z, vX, vY, vZ, scale, age, maxAge, color);
      this.flip = flipped;
      this.startRot = startRot;
   }
