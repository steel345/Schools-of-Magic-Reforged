...
public class DivinationEffect extends ImitationSpiteEffect {
   private boolean flip;
   private float startRot;

   public DivinationEffect(Level world, double x, double y, double z, boolean flipped, float startRot) {
   ...
   public DivinationEffect(Level world, double x, double y, double z, float scale, int age, int maxAge, boolean flipped, float startRot) {
   ...
   public DivinationEffect(Level world, double x, double y, double z, double vX, double vY, double vZ, float scale, int age, int maxAge, Color color, boolean flipped, float startRot) {
